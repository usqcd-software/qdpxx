...
\newcommand{\protoBBinaryQual}[1]{{\it Type }{\tt #1}{\tt (const }{\it Type}{\tt \& a,}{\tt const }{\it Type}{\tt \& b)}}
\newcommand{\protoBoolBinaryQual}[1]{{\it Type2 }{\tt #1}{\tt (const }{\it Type}{\tt \& a,}{\tt const }{\it Type1}{\tt \& b)}}
...
\begin{flushleft}
\begin{tabular}{lcp{4.0in}}
\verb|conj|             &:& hermitian conjugate (adjoint)\\
...
\verb|multiplyI|        &:& multiplies argument by imag "i"\\
\verb|multiplyMinusI|   &:& multiplies argument by imag "-i"\\
\verb|localNorm2|       &:& on fibers computes trace(conj(source)*source)\\
\end{tabular}
\end{flushleft}
...
\verb|localInnerproduct|  &:& at each site computes trace(conj(arg1)*arg2)\\
\end{tabular}
\end{flushleft}
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt double toDouble(const Double\& a)} \\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt LatticeComplex }{\tt peekColor(const LatticeColorVector}{\tt \& a, }\\
              &\quad         {\tt int i)}\\
              & {\tt LatticeSpinVector }{\tt peekColor(const LatticeDiracFermion}{\tt \& a, }\\
              &\quad         {\tt int i)}\\
  \hline
  Meaning     & $r = a_{i}$\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt LatticeColorVector\& pokeColor(LatticeColorVector\& r, }\\
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt LatticeComplex }{\tt peekSpin(const LatticeSpinMatrix}{\tt \& a, }\\
              &\quad         {\tt int i, int j)}\\
              & {\tt LatticeColorMatrix }{\tt peekSpin(const LatticePropagator}{\tt \& a, }\\
              &\quad         {\tt int i, int j)}\\
  \hline
  Meaning     & $r = a_{i,j}$\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt LatticeSpinMatrix\& pokeSpin(LatticeSpinMatrix\& r, }\\
              &   \quad{\tt const LatticeComplex\& a, int i, int j)}\\
  \hline
  Meaning     & $r_{i,j} = a$\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt LatticeComplex }{\tt peekSpin(const LatticeSpinVector}{\tt \& a, }\\
              &\quad         {\tt int i)}\\
              & {\tt LatticeColorVector }{\tt peekSpin(const LatticeDiracFermion}{\tt \& a, }\\
              &\quad         {\tt int i)}\\
  \hline
  Meaning     & $r = a_{i}$\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt LatticeSpinVector\& pokeSpin(LatticeSpinVector\& r, }\\
              &   \quad{\tt const LatticeComplex\& a, int i)}\\
  \hline
  Meaning     & $r_{i} = a$\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type2 }{\tt trace(const }{\it Type1}{\tt \& a)}\\
  \hline
  Meaning     & $r = \Tr a$ \\
  \hline
  ...
  \hline
  Example     & {\it LatticeComplex }{\tt trace(const }{\it LatticeColorMatrix}{\tt \& a)}\\
  \hline
  \end{tabular}
\end{flushleft}
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type2 }{\tt traceColor(const }{\it Type1}{\tt \& a)}\\
  \hline
  Meaning     & $r = \Tr a$ \\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type2 }{\tt traceSpin(const }{\it Type1}{\tt \& a)}\\
  \hline
  Meaning     & $r = \Tr a$ \\
  \hline
  ...
  \hline
  Example     & {\it LatticeColorMatrix }{\tt trace(const }{\it LatticeDiracPropagator}{\tt \& a)}\\
  \hline
  \end{tabular}
\end{flushleft}

Traces only over spin matrix indices. It is an error to trace over a spin vector index.
All other indices are left untouched.
It will trivially trace a scalar variable.
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline 
  Syntax      & {\it Type2 }{\tt spinProject(const }{\it Type1}{\tt \& a, int d, int p)}\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type }{\tt operator*(const Real\& a, const }{\it Type}{\tt \& b)}\\
              & {\it Type }{\tt operator*(const }{\it Type}{\tt \& b, const Real\& a)}\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type }{\tt operator*(const }{\it Gamma}{\tt \& a, const }{\it Type}{\tt \& b)}\\
  \hline
  Meaning     & $r = \gamma_d a$ \\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type }{\tt operator*(const }{\it Type}{\tt \& a, const }{\it Gamma}{\tt \& b)}\\
  \hline
  Meaning     & $r = a \gamma_d$ \\
  \hline
  {\it Gamma} & Gamma constructed from an explicit integer in $[0,N_s^2-1]$\\
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type }{\tt operator*(const }{\it Type1}{\tt \& a, const }{\it Type}{\tt \& b)}\\
  \hline
  Meaning     & $r = a * b$ \\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type }{\tt operator*(const }{\it Type}{\tt \& a, const }{\it Type1}{\tt \& b)}\\
  \hline
  Meaning     & $r = a * b$ \\
  \hline
  {\it Type1} & \tColorMatrix, \tLatticeColorMatrix\\
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt void copymask(const }{\it Type2\& }{\tt r, const }{\it Type1}
{\tt \& a, const }{\it Type1}{\tt \& b)}\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt Real norm2(}{\it Type}{\tt \& a)}\\
  \hline
  Meaning     & $r = \sum |a|^2$ \\
  \hline
  \itt        & \allNumericTypes \\
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt Complex innerproduct(}{\it Type}{\tt \& a, const }{\it Type }{\tt \& b)}\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type}{\tt \ sum(}{\tt const Lattice}{\it Type}{\tt \& a)}\\
  \hline
  Meaning     & $r = \sum a$\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt LatticeInteger latticeCoordinate(int d)}\\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt Lattice}{\it Type} {\tt operator=(}{\tt Lattice}{\it Type}{\tt \& r, const }
{\it Type}{\tt \& a)}\\
  \hline
...
NOTE, one can not fill a \tLatticeColorMatrix with a \tReal.
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\it Type} {\tt operator=(}{\it Type}{\tt \& r, const Zero\& zero)}\\
  \hline
  Meaning     & $r = 0$\\
  \hline
  \itt        & \allNumericTypes \\
  \hline
  Example     & \verb|LatticeFermion = zero;|\\
  \hline
  \end{tabular}
\end{flushleft}
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt void random}{\tt (const }{\it Type }{\tt \&r)} \\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt void gaussian}{\tt (const }{\it Type }{\tt \&r)} \\
  \hline
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt void RNG}\ttdash{\tt setrn(}{const \tt Seed\& a)} \\
  \hline
  Meaning     & Initialize the random number generator with seed state {\tt a}\\
  \hline
  \end{tabular}
\end{flushleft}
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt void RNG}\ttdash{\tt savern(}{\tt Seed\& r)} \\
  \hline
  Meaning     & Extract the random number generator into seed state {\tt r}\\
  \hline
  \end{tabular}
\end{flushleft}
