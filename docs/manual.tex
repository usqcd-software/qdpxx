% -*-LaTeX-*- document QDP API (C++ Language Binding) version 0.6
%
...
routine \verb|latticeCoordinates|.  However, if a user removes data
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Prototype      & {\tt \tLatticeInt} \verb|latticeCoordinate(int i)|\\
  \hline
  Purpose        & The {\tt i}th spacetime coordinate. \\
  \hline
  Example        & {\tt \tLatticeInt{} coord = latticeCoordinate(2);} \\
  \hline
 \end{tabular}
\end{flushleft}
%
The call \verb|latticeCoordinate(i)| returns an integer lattice field with a
...
\begin{flushleft}
  \begin{tabular}{|l|l|}
  \hline
  Syntax      & {\tt \tLatticeInt} \verb|latticeCoordinate|({\tt int d})\\
  \hline
