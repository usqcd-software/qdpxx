% -*-LaTeX-*- document QDP API (C++ Language Binding) version 0.5
%
...
\begin{document}
\title{
   QDP++ Data Parallel Interface for QCD  \\{\large Version 0.5}
}
...
\verb|outerProduct|       &:& at each site constructs (arg1_i * arg2_j^*)_{ij}\\
\end{tabular}
\end{flushleft}
