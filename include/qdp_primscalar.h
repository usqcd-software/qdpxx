...
public:
  ...
  //! Deep copies here
  PETE_DEVICE PScalar(const PScalar& a): F(a.F) {/* fprintf(stderr,"copy PScalar\n"); */}
...
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, OpNot>::Type_t
...
// + PScalar
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, OpUnaryPlus>::Type_t
operator+(const PScalar<T1>& l)
{
  return +l.elem();
}
...
// - PScalar
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, OpUnaryMinus>::Type_t
operator-(const PScalar<T1>& l)
{
  return -l.elem();
}
...
// PScalar + PScalar
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpAdd>::Type_t
...
// PScalar - PScalar
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpSubtract>::Type_t
operator-(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() - r.elem();
}
...
// PScalar * PScalar
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpMultiply>::Type_t
operator*(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() * r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpAdjMultiply>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpMultiplyAdj>::Type_t
...
// Optimized  PMatrix*adj(PMatrix)
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2,4>, OpMultiplyAdj>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpAdjMultiplyAdj>::Type_t
...
// PScalar / PScalar
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpDivide>::Type_t
operator/(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() / r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpLeftShift>::Type_t
operator<<(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() << r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpRightShift>::Type_t
operator>>(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() >> r.elem();
}
...
// PScalar % PScalar
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpMod>::Type_t
operator%(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() % r.elem();
}
...
// PScalar ^ PScalar
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpBitwiseXor>::Type_t
operator^(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() ^ r.elem();
}
...
// PScalar & PScalar
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpBitwiseAnd>::Type_t
operator&(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() & r.elem();
}
...
// PScalar | PScalar
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpBitwiseOr>::Type_t
operator|(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() | r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpLT>::Type_t
operator<(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() < r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpLE>::Type_t
operator<=(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() <= r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpGT>::Type_t
operator>(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() > r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpGE>::Type_t
operator>=(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() >= r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpEQ>::Type_t
operator==(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() == r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpNE>::Type_t
operator!=(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() != r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpAnd>::Type_t
operator&&(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() && r.elem();
}
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, OpOr>::Type_t
operator||(const PScalar<T1>& l, const PScalar<T2>& r)
{
  return l.elem() || r.elem();
}
...
// Adjoint
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnAdjoint>::Type_t
...
// Conjugate
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnConjugate>::Type_t
...
// Transpose
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnTranspose>::Type_t
...
// trace = Trace(source1)
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnTrace>::Type_t
...
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnRealTrace>::Type_t
...
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnImagTrace>::Type_t
...
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnTraceColor>::Type_t
...
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnTraceSpin>::Type_t
...
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnTransposeSpin>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnTraceMultiply>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnTraceColorMultiply>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnTraceSpinMultiply>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnTraceSpinOuterProduct>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnOuterProduct>::Type_t
...
//! PScalar = Re(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnReal>::Type_t
...
// PScalar = Im(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnImag>::Type_t
...
// ArcCos
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnArcCos>::Type_t
...
// ArcSin
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnArcSin>::Type_t
...
// ArcTan
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnArcTan>::Type_t
...
// Ceil(ing)
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnCeil>::Type_t
...
// Cos
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnCos>::Type_t
...
// Cosh
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnHypCos>::Type_t
...
// Exp
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnExp>::Type_t
...
// Fabs
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnFabs>::Type_t
...
// Floor
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnFloor>::Type_t
...
// Log
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnLog>::Type_t
...
// Log10
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnLog10>::Type_t
...
// Sin
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnSin>::Type_t
...
// Sinh
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnHypSin>::Type_t
...
// Sqrt
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnSqrt>::Type_t
...
// Tan
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnTan>::Type_t
...
// Tanh
template<class T1>
PETE_DEVICE inline typename UnaryReturn<PScalar<T1>, FnHypTan>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnPow>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnArcTan2>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnCmplx>::Type_t
...
// PScalar = i * PScalar
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnTimesI>::Type_t
...
// PScalar = -i * PScalar
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnTimesMinusI>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSeedToFloat>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnGetSite>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnPeekColorVector>::Type_t
...
/*! Generically, this is an identity operation. Defined differently under color */
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnPeekColorMatrix>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnPeekSpinVector>::Type_t
...
/*! Generically, this is an identity operation. Defined differently under spin */
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnPeekSpinMatrix>::Type_t
...
PETE_DEVICE inline typename BinaryReturn<GammaConst<N,m>, PScalar<T2>, OpGammaConstMultiply>::Type_t
...
template<class T2, int N, int m>
PETE_DEVICE inline typename BinaryReturn<PScalar<T2>, GammaConst<N,m>, OpGammaConstMultiply>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinProjectDir0Minus>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinReconstructDir0Minus>::Type_t
...
//! PScalar = SpinProject(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinProjectDir1Minus>::Type_t
...
//! PScalar = SpinReconstruct(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinReconstructDir1Minus>::Type_t
...
//! PScalar = SpinProject(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinProjectDir2Minus>::Type_t
...
//! PScalar = SpinReconstruct(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinReconstructDir2Minus>::Type_t
...
//! PScalar = SpinProject(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinProjectDir3Minus>::Type_t
...
//! PScalar = SpinReconstruct(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinReconstructDir3Minus>::Type_t
...
//! PScalar = SpinProject(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinProjectDir0Plus>::Type_t
...
//! PScalar = SpinReconstruct(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinReconstructDir0Plus>::Type_t
...
//! PScalar = SpinProject(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinProjectDir1Plus>::Type_t
...
//! PScalar = SpinReconstruct(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinReconstructDir1Plus>::Type_t
...
//! PScalar = SpinProject(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinProjectDir2Plus>::Type_t
...
//! PScalar = SpinReconstruct(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinReconstructDir2Plus>::Type_t
...
//! PScalar = SpinProject(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinProjectDir3Plus>::Type_t
...
//! PScalar = SpinReconstruct(PScalar)
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSpinReconstructDir3Plus>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnChiralProjectPlus>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnChiralProjectMinus>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnQuarkContract13>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnQuarkContract14>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnQuarkContract23>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnQuarkContract24>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnQuarkContract12>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnQuarkContract34>::Type_t
...
template<class T1, class T2, class T3>
PETE_DEVICE inline typename TrinaryReturn<PScalar<T1>, PScalar<T2>, PScalar<T3>, FnColorContract>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnColorVectorContract>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnColorCrossProduct>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnSum>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnLocalNorm2>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnGlobalMax>::Type_t
...
template<class T>
PETE_DEVICE inline typename UnaryReturn<PScalar<T>, FnGlobalMin>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnLocalInnerProduct>::Type_t
...
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PScalar<T1>, PScalar<T2>, FnLocalInnerProductReal>::Type_t
...
template<class T1, class T2, class T3>
PETE_DEVICE inline typename TrinaryReturn<PScalar<T1>, PScalar<T2>, PScalar<T3>, FnWhere>::Type_t
...
template<class T> 
PETE_DEVICE inline typename WordType< PScalar<T> >::Type_t
