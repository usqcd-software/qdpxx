...
template<class T, int N>
PETE_DEVICE inline typename UnaryReturn<PColorVector<T,N>, FnPeekColorVector>::Type_t
...
template<class T1, class T2, int N>
PETE_DEVICE inline PColorVector<T1,N>&
...
PETE_DEVICE inline typename TrinaryReturn<PColorVector<T1,3>, PColorVector<T2,3>, PColorVector<T3,3>, FnColorContract>::Type_t
 ...
 */
template<class T1, class T2, int N>
PETE_DEVICE inline typename BinaryReturn<PColorVector<T1,N>, PColorVector<T2,N>, FnColorVectorContract>::Type_t
 ...
 */
template<class T1, class T2>
PETE_DEVICE inline typename BinaryReturn<PColorVector<T1,3>, PColorVector<T2,3>, FnColorCrossProduct>::Type_t
