...
timeMeqHM___QDP__::run(void) 
{
  ...
  QDPIO::cout << std::endl << "Timing  QDP++ HM Kernel " <<std::endl;
  ...
  QDPIO::cout << "QDP++ HM Kernel: " << perf << " Mflops" << std::endl;
...
timeMeqHM::run(void) 
{
  ...
  QDPIO::cout << std::endl << "Timing SSE D  M=HM  Kernel " <<std::endl;
  ...
  double flops=(double)(198*Layout::vol());
  double perf=(flops/time)/(double)(1024*1024);
  QDPIO::cout << "SSED HM Kernel: " << perf << " Mflops" << std::endl;
...
timeMPeqaHM___QDP__::run(void) 
{
  ...
  QDPIO::cout << std::endl << "Timing  QDP++ M+=HM Kernel " <<std::endl;
  ...
  double perf=(flops/time)/(double)(1024*1024);
  QDPIO::cout << "QDP++ M+=HM Kernel: " << perf << " Mflops" << std::endl;
