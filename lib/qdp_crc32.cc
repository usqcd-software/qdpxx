...
#define DO8(buf)  DO4(buf); DO4(buf);
  ...
  /* ========================================================================= */
  /* =============== Improved CRC32 algorithm processing 8 bytes ============= */
  typedef n_uint32_t uint32_t;
  ...
  uint32_t crc32_4bytes_little_endian (const void* data, size_t length, uint32_t previousCrc32)
  {
  ...
  /// compute CRC32 (Slicing-by-4 algorithm)
  uint32_t crc32_4bytes_big_endian (const void* data, size_t length, uint32_t previousCrc32)
  {
    uint32_t  crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
    const uint32_t* current = (const uint32_t*) data;
  ...
  uint32_t crc32_8bytes_little_endian (const void* data, size_t length, uint32_t previousCrc32)
  {
    uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
    const uint32_t* current = (const uint32_t*) data;
  ...
  /// compute CRC32 (Slicing-by-8 algorithm)
  uint32_t crc32_8bytes_big_endian (const void* data, size_t length, uint32_t previousCrc32)
  {
    uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
    const uint32_t* current = (const uint32_t*) data;
  ...
  n_uint32_t crc32(n_uint32_t crc, const unsigned char *buf, size_t len)
  {
    if (!QDPUtil::big_endian()) {
      return crc32_8bytes_little_endian (buf, len, crc);
    }
    else {
      return crc32_8bytes_big_endian (buf, len, crc);
    }
  }
